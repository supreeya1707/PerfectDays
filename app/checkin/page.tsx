    ...
    <div className="containner ">
      <div className="bg-local  bgImgback grid grid-cols-1">
        ...
        <div className=" grid grid grid-flow-row auto-rows-max justify-self-center content-center  ">
          ...
          <div className="grid grid-cols-1  justify-self-center text-center  text-2xl  mb-6 border-4 rounded-lg p-2 text-blue-600 border-indigo-500/100 w-[220px] h-[49px]">
            08:14
          </div>
